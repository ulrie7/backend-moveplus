const TrajetValidations = require('../../validations/trajet.validations');

describe('TrajetValidations', () => {
  describe('CreateValidation', () => {
    it('should pass with valid complete data', () => {
      const { error } = TrajetValidations.CreateValidation({
  ...
  describe('UpdateValidation', () => {
    it('should pass with partial data', () => {
      const { error } = TrajetValidations.UpdateValidation({
