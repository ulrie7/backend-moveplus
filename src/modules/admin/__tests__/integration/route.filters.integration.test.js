...
const { createTestRoute } = require('../helpers/route.helper');

describe('Route Filters Integration', () => {
  let mongoServer;
  let app;
  let request;
  ...
  beforeAll(async () => {
    ...
    // Seed routes for filtering
    await createTestRoute(request, {
  ...
  describe('GET /api/v1/route with filters', () => {
